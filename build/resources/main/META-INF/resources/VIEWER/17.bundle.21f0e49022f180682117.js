...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/react-cornerstone-viewport/dist/index.umd.js
var index_umd = __webpack_require__(1347);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/lodash.throttle/index.js
var lodash_throttle = __webpack_require__(234);
var lodash_throttle_default = /*#__PURE__*/__webpack_require__.n(lodash_throttle);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/extensions/cornerstone/src/state.js
var src_state = __webpack_require__(64);

// CONCATENATED MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/extensions/cornerstone/src/ConnectedCornerstoneViewport.js
...
var ConnectedCornerstoneViewport_mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  if (isActive) {
    Object(src_state["c" /* setActiveViewportIndex */])(viewportIndex);
  }
...
var ConnectedCornerstoneViewport_mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  ...
  return {
    setViewportActive: function setViewportActive() {
      ...
      if (viewportIndex !== Object(src_state["a" /* getActiveViewportIndex */])()) {
    ...
    onElementEnabled: function onElementEnabled(event) {
      ...
      Object(src_state["d" /* setEnabledElement */])(viewportIndex, enabledElement);
...
var ConnectedCornerstoneViewport = Object(es["b" /* connect */])(ConnectedCornerstoneViewport_mapStateToProps, ConnectedCornerstoneViewport_mapDispatchToProps)(index_umd_default.a);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/cornerstone-core/dist/cornerstone.js
var cornerstone = __webpack_require__(5);
var cornerstone_default = /*#__PURE__*/__webpack_require__.n(cornerstone);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/lodash.debounce/index.js
var lodash_debounce = __webpack_require__(1339);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/extensions/cornerstone/src/CustomLoader.css
var src_CustomLoader = __webpack_require__(1348);

// CONCATENATED MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/extensions/cornerstone/src/OHIFCornerstoneViewport.js
...
var _OHIF$utils = src["a" /* default */].utils,
    StackManager = _OHIF$utils.StackManager,
    studyMetadataManager = _OHIF$utils.studyMetadataManager;
...
function (_Component) {
  ...
  _createClass(OHIFCornerstoneViewport, [{
    ...
    value: function render() {
      ...
      var debouncedNewImageHandler = lodash_debounce_default()(function (_ref3) {
        var currentImageIdIndex = _ref3.currentImageIdIndex,
            sopInstanceUid = _ref3.sopInstanceUid;
        ...
        if (currentImageIdIndex > 0) {
          ...
          //   activeViewportIndex: viewportIndex,
          // });
          var study = studyMetadataManager.get(_this3.props.viewportData.displaySet.StudyInstanceUID); // ToDo: look into setViewportSpecificData broken dispatch
          // props..displayset doesn't update, use findDisplaySet instead

          var displaySet = study.findDisplaySet(function (ds) {
            return ds.images && ds.images.find(function (i) {
              return i.getSOPInstanceUID() === sopInstanceUid;
            });
          });
          displaySet.SOPInstanceUID = sopInstanceUid;
          displaySet.frameIndex = currentImageIdIndex;
          _this3.state.viewportData.stack.currentImageIdIndex = currentImageIdIndex;
        }
      }, 700);
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(src_ConnectedCornerstoneViewport, _extends({
        ...
        imageIds: imageIds,
        viewportOverlayComponent: xnat_src["e" /* XNATViewportOverlay */],
        loadingIndicatorComponent: OHIFCornerstoneViewport_CustomLoader,
        imageIdIndex: currentImageIdIndex,
        onNewImage: debouncedNewImageHandler // newImageHandler slows scrolling
        // onNewImage={newImageHandler}
        ,
        onNewImageDebounceTime: 0 // ~~ Connected (From REDUX)
        // frameRate={frameRate}
        // isPlaying={false}
...
var OHIFCornerstoneViewport_CustomLoader =
/*#__PURE__*/
function (_Component2) {
  _inherits(CustomLoader, _Component2);

  function CustomLoader() {
    _classCallCheck(this, CustomLoader);

    return _possibleConstructorReturn(this, _getPrototypeOf(CustomLoader).apply(this, arguments));
  }
