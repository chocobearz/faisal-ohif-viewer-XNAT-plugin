...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/react-router-dom/esm/react-router-dom.js
var react_router_dom = __webpack_require__(140);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/react-router/esm/react-router.js + 1 modules
var react_router = __webpack_require__(86);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/react-i18next/dist/es/index.js + 9 modules
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/classnames/index.js
...
var HotkeysPreferences = __webpack_require__(1349);
...
function HotkeysPreferences_HotkeysPreferences(_ref2) {
  ...
  var snackbar = Object(src["O" /* useSnackbarContext */])();
...
var react_redux_es = __webpack_require__(56);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/platform/core/src/redux/index.js + 12 modules
var redux = __webpack_require__(317);

// EXTERNAL MODULE: ./components/UserPreferences/WindowLevelPreferences.styl
var WindowLevelPreferences = __webpack_require__(1350);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/platform/i18n/src/index.js + 22 modules
var i18n_src = __webpack_require__(132);
...
var GeneralPreferences = __webpack_require__(1351);
...
function GeneralPreferences_GeneralPreferences(_ref) {
  ...
  var syncStrategies = ['Index', 'Position'];

  var _useState3 = Object(react["useState"])(xnat_src["h" /* stackSynchronizer */].sycStrategy),
      _useState4 = GeneralPreferences_slicedToArray(_useState3, 2),
      syncStrategy = _useState4[0],
      setSyncStrategy = _useState4[1];
  ...
  var onSave = function onSave() {
    ...
    xnat_src["h" /* stackSynchronizer */].changeSynchronizationStrategy(syncStrategy);
    onClose();
    snackbar.show({
      message: t('SaveMessage'),
      type: 'success'
  ...
  })), react_default.a.createElement("h2", null, "Stack Scroll Synchronization Settings"), react_default.a.createElement("hr", null), react_default.a.createElement("div", {
    className: "generalItem"
  }, react_default.a.createElement("label", {
    htmlFor: "sync-strategy-select",
    className: "generalLabel"
  }, "Sync Method"), react_default.a.createElement("select", {
    id: "sync-strategy-select",
    value: syncStrategy,
    onChange: function onChange(_ref2) {
      var target = _ref2.target;
      return setSyncStrategy(target.value);
    }
  }, syncStrategies.map(function (strategy, key) {
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/lodash/lodash.js
var lodash = __webpack_require__(1352);

// EXTERNAL MODULE: ./components/UserPreferences/ExperimentalFeatures.styl
var ExperimentalFeatures = __webpack_require__(1353);

// CONCATENATED MODULE: ./components/UserPreferences/ExperimentalFeatures.js
function ExperimentalFeatures_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function ExperimentalFeatures_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ExperimentalFeatures_ownKeys(source, true).forEach(function (key) { ExperimentalFeatures_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ExperimentalFeatures_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function ExperimentalFeatures_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function ExperimentalFeatures_slicedToArray(arr, i) { return ExperimentalFeatures_arrayWithHoles(arr) || ExperimentalFeatures_iterableToArrayLimit(arr, i) || ExperimentalFeatures_nonIterableRest(); }

function ExperimentalFeatures_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function ExperimentalFeatures_iterableToArrayLimit(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function ExperimentalFeatures_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var ExperimentalFeatures_actions = redux["a" /* default */].actions;
/**
...
function ExperimentalFeatures_ExperimentalFeatures(_ref) {
  var onClose = _ref.onClose;
  ...
  var snackbar = Object(src["O" /* useSnackbarContext */])();
  var dispatch = Object(react_redux_es["c" /* useDispatch */])();
  var experimentalFeatures = Object(react_redux_es["d" /* useSelector */])(function (state) {
    var _state$preferences = state.preferences,
        preferences = _state$preferences === void 0 ? {} : _state$preferences;
    var _preferences$experime = preferences.experimentalFeatures,
        experimentalFeatures = _preferences$experime === void 0 ? {} : _preferences$experime;
    return experimentalFeatures;
  });

  var _useState = Object(react["useState"])({
    features: ExperimentalFeatures_objectSpread({}, experimentalFeatures)
  }),
      _useState2 = ExperimentalFeatures_slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];
  ...
  var onSave = function onSave() {
    dispatch(ExperimentalFeatures_actions.setUserPreferences({
      experimentalFeatures: state.features
    }));
    onClose();
    snackbar.show({
      message: t('SaveMessage'),
  ...
  var onToggleClick = function onToggleClick(event) {
    ...
    var feature = state.features[key];
    var isEnabled = feature.enabled;
    setState(function (prevState) {
      return ExperimentalFeatures_objectSpread({}, prevState, {
        features: ExperimentalFeatures_objectSpread({}, prevState.features, ExperimentalFeatures_defineProperty({}, key, ExperimentalFeatures_objectSpread({}, feature, {
          enabled: !isEnabled
        })))
      });
    });
  ...
  return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("div", {
    className: "ExperimentalFeatures"
  }, _.isEmpty(state.features) ? react_default.a.createElement("h4", null, " No experimental features ") : Object.keys(state.features).map(function (key) {
    return react_default.a.createElement("div", {
      className: "feature",
      key: key
    }, react_default.a.createElement("label", {
      className: "featureLabel"
    }, state.features[key].name), react_default.a.createElement("input", {
      type: "checkbox",
      "data-key": key,
...
ExperimentalFeatures_ExperimentalFeatures.propTypes = {
  onClose: prop_types_default.a.func
};

// EXTERNAL MODULE: ./components/UserPreferences/UserPreferences.styl
var UserPreferences = __webpack_require__(1354);
...
var tabs = [{
  ...
  Component: ExperimentalFeatures_ExperimentalFeatures,
  customProps: {}
}];
...
// EXTERNAL MODULE: ./components/OHIFLogo/OHIFLogo.js + 1 modules
var OHIFLogo = __webpack_require__(638);

// EXTERNAL MODULE: ./components/Header/Header.css
var Header = __webpack_require__(1355);
...
function OptionsElement(props) {
  ...
  }, react_default.a.createElement(src["j" /* Icon */], {
    name: "xnat-settings",
    width: "18px",
    height: "18px" // style={{ margin: '0 5 0 0' }}
...
function Header_Header(props) {
  ...
  Object(react["useEffect"])(function () {
    var optionsValue = [{
      ...
      onClick: function onClick() {
        return show({
          content: xnat_src["b" /* ICRHelpContent */],
    ...
    // },
    {
      ...
      onClick: function onClick() {
        return show({
          content: xnat_src["a" /* ICRAboutContent */],
  ...
  }), react_default.a.createElement(src["e" /* Dropdown */] // titleElement={<OptionsElement />}
  , {
    title: t('Options'),
    list: options,
    align: "right"
...
Header_Header.defaultProps = {
  useLargeLogo: false,
  children: react_default.a.createElement(OHIFLogo["a" /* default */], null)
};
/* harmony default export */ var components_Header_Header = (Object(es["d" /* withTranslation */])(['Header', 'AboutModal'])(Object(react_router["g" /* withRouter */])(Object(src["Q" /* withModal */])(Header_Header))));
