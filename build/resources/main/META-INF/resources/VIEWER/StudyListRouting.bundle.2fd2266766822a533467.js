...
var ui_src = __webpack_require__(9);

// EXTERNAL MODULE: ./connectedComponents/ConnectedHeader.js + 9 modules
var ConnectedHeader = __webpack_require__(1345);

// EXTERNAL MODULE: ./routes/routesUtil.js
var routesUtil = __webpack_require__(201);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/moment/moment.js
var moment = __webpack_require__(8);
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/react-bootstrap-modal/lib/Modal.js
var Modal = __webpack_require__(1364);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/dicomweb-client/build/dicomweb-client.es.js
var dicomweb_client_es = __webpack_require__(30);

// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/platform/core/src/errorHandler.js
...
var googleCloud_DicomUploader = __webpack_require__(1370);
...
function DicomFileUploaderModal_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { DicomFileUploaderModal_typeof = function _typeof(obj) { return typeof obj; }; } else { DicomFileUploaderModal_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return DicomFileUploaderModal_typeof(obj); }
...
var DicomFileUploaderModal_DicomFileUploaderModal =
/*#__PURE__*/
function (_Component) {
  ...
  function DicomFileUploaderModal() {
    ...
    _this = DicomFileUploaderModal_possibleConstructorReturn(this, (_getPrototypeOf2 = DicomFileUploaderModal_getPrototypeOf(DicomFileUploaderModal)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  DicomFileUploaderModal_createClass(DicomFileUploaderModal, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement(Modal_default.a, {
        ...
        size: 'md',
        keyboard: true
      }, react_default.a.createElement(Modal_default.a.Header, {
        closeButton: true
      }, react_default.a.createElement(Modal_default.a.Title, null, this.props.t('Upload DICOM Files'))), react_default.a.createElement(Modal_default.a.Body, null, react_default.a.createElement(DicomUploader_DicomUploader, {
        url: this.props.url,
...
var GoogleCloudApi = __webpack_require__(1331);

// EXTERNAL MODULE: ./googleCloud/googleCloud.css
var googleCloud = __webpack_require__(1329);
...
var getServers = __webpack_require__(1338);
...
var filesToStudies = __webpack_require__(1341);

// EXTERNAL MODULE: ./context/UserManagerContext.js
var UserManagerContext = __webpack_require__(330);

// EXTERNAL MODULE: ./context/WhiteLabelingContext.js
var WhiteLabelingContext = __webpack_require__(310);
...
function StudyListRoute(props) {
  ...
  var displaySize = Object(ui_src["N" /* useMedia */])(['(min-width: 1750px)', '(min-width: 1000px) and (max-width: 1749px)', '(max-width: 999px)'], ['large', 'medium', 'small'], 'small'); // ~~ DEBOUNCED INPUT

  var debouncedSort = Object(ui_src["M" /* useDebounce */])(sort, 200);
  var debouncedFilters = Object(ui_src["M" /* useDebounce */])(filterValues, 250); // Google Cloud Adapter for DICOM Store Picking
...
var useServer = __webpack_require__(1340);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _googleCloud_api_GoogleCloudApi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1331);
/* harmony import */ var _usePrevious__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1328);
/* harmony import */ var _googleCloud_utils_getServers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1338);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(56);
/* harmony import */ var lodash_isequal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(309);
/* harmony import */ var lodash_isequal__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_isequal__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _context_AppContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(106);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/cornerstone-wado-image-loader/dist/cornerstoneWADOImageLoader.min.js
var cornerstoneWADOImageLoader_min = __webpack_require__(61);
...
// EXTERNAL MODULE: /faisal/faisal-repo/ohif-viewer-xnat-plugin/ohifviewerxnat/node_modules/dcmjs/build/dcmjs.es.js
var dcmjs_es = __webpack_require__(25);
...
function (_FileLoader) {
  ...
  dicomFileLoader_createClass(_temp, [{
    ...
    value: function getDataset(image, imageId) {
      ...
      try {
        var dicomData = dcmjs_es["b" /* default */].data.DicomMessage.readFile(image);
        dataset = dcmjs_es["b" /* default */].data.DicomMetaDictionary.naturalizeDataset(dicomData.dict);
        metadataProvider.addInstance(dataset);
        dataset._meta = dcmjs_es["b" /* default */].data.DicomMetaDictionary.namifyDataset(dicomData.meta);
      } catch (e) {
